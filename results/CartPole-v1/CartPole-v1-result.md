# Results for CartPole-v1

This document summarizes the results for the CartPole-v1 environment.
...
<p align="center">
  <img src="CartPole-v1_mlp_large.gif" alt="Agent Performance GIF">
</p>
...
```bash
python src/test_model.py --model-path results/CartPole-v1/CartPole-v1-model.pt --model-string mlp_large --env CartPole-v1 --interactive --episodes 10
```
...
```bash
python src/test_model.py --model-path results/CartPole-v1/CartPole-v1-model.pt --model-string mlp_large --env CartPole-v1 --episodes 5 --output results/CartPole-v1/CartPole-v1_mlp_large.gif
```